...
export const brand = {
  ...
  pitch: {
    en: 'A family app for tasks, notes, and dates — with private notes that stay private.',
    ru: 'Охана помогает семье помнить поручения, заметки и важные даты — без лишней нагрузки на одного человека.',
  },
